...
void PanningCamera::update(const Window& window, float dt, bool controls_enabled) {
    ...
    glm::vec3 rotationAxisYaw(0.0f, 1.0f, 0.0f);
    glm::vec3 rotationAxisPitch(1.0f, 0.0f, 0.0f);
    glm::mat4 rotationYaw = glm::rotate(yaw, rotationAxisYaw);
    glm::mat4 rotationPitch = glm::rotate(pitch, rotationAxisPitch);
    glm::mat4 inverse_rot_matrix = rotationYaw * rotationPitch;
    glm::vec3 forward = glm::vec3(inverse_rot_matrix[2]);
    glm::vec3 translation(-focus_point.x, -focus_point.y, -focus_point.z);
    glm::mat4 translationMatrix = glm::translate(translation);
    glm::mat4 rotationMatrix = glm::mat4_cast(glm::conjugate(glm::quat_cast(inverse_rot_matrix)));
    glm::mat4 scaleMatrix = glm::translate(glm::vec3(0.0f, 0.0f, -distance));
    view_matrix = scaleMatrix * rotationMatrix * translationMatrix;
