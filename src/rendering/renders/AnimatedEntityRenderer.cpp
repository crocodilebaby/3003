...
void AnimatedEntityRenderer::AnimatedEntityRenderer::render(const RenderScene& render_scene, const LightScene& light_scene) {
    ...
    for (const auto& entity: render_scene.entities) {
        ...
        //dl
        glm::vec3 direction = glm::normalize(entity->instance_data.model_matrix[2]);
        // IMPORTANT NOTE:
        ...
        //dl
        shader.set_directional_lights(light_scene.get_nearest_directional_lights(direction, BaseLitEntityShader::MAX_DL, 1));
